...
qx.Class.define("landing_qooxdoo.Application",
  {
    ...
    members:
    {
      ...
      main() {
        ...
        // Create page container - scrollable; order is [page slot, footer] so footer stays at bottom
        ...
        this._pageContent.add(this._footer);
      ...
      _navigateTo(path) {
        ...
        // Remove current page from slot
        if (this._currentPage) {
          try {
            if (!this._currentPage.isDisposed()) {
              this._pageSlot.remove(this._currentPage);
